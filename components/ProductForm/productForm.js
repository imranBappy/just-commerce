    ...
    <>
      ...
      >
        ...
        {/* <div className="card mb-5 border-0 shadow">
          ...
          <div className="p-3">
            <h6 className="mb-3 pb-2 border-bottom">General</h6>
            <div className="d-flex mb-2">
              <p className="mr-2 mb-0 col-2">Available</p>
              <textarea
                id="inp-7"
            ...
            <div className="d-flex mb-2">
              <p className="mr-2 mb-0 col-2">Dimensions</p>
              <textarea
                id="inp-7"
                className="form-control"
                name="short_description"
            ...
            <h6 className="mb-3 pb-2 border-bottom">PLATFORM</h6>
            <div className="d-flex mb-2">
              <p className="mr-2 mb-0 col-2">Available</p>
              <textarea
                id="inp-7"
